...
namespace mage
{
	class Effect
	{
		...
		public:
			...
			Effect& setMatrices(const std::string& name, const D3DXMATRIX* matrices, UINT count);
			Effect& setMatrices(const std::string& name, const std::vector<D3DXMATRIX>& matrices);
