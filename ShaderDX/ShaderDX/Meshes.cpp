...
HRESULT dx9lib::DX9LIB_BuildSphere(IDirect3DDevice9* device, int slices, int stacks, float radius, SimpleMesh* mesh)
{
	HRESULT hr = S_OK;
	...
	mesh->useTriangleStrip = true;
	mesh->triangles = mesh->indexes - 2;
